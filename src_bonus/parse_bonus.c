...
/*   Updated: 2025/06/07 10:22:32 by hnagashi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color parse_color(char *str)//OK
{
    t_color color = {0, 0, 0};
...
void parse_ambient(t_scene *scene, char ***tokens)//OK
{
...
int is_empty_or_comment(char *line)//OK
{
    int i = 0;
...
void parse_line(char *line, t_scene *scene)//OK
{
    char **tokens;
...
void parse_rt_file(const char *filename, t_scene *scene)//OK
{
	int		fd;
	char	*line;
    int has_read = 0;
