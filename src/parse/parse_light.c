...
/*   Updated: 2025/06/05 18:22:44 by hnagashi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	light_token(t_scene *scene, char ***tokens, size_t count_tokens);
...
void	light_token(t_scene *scene, char ***tokens, size_t count_tokens)
{
	if (scene->light_count++)
		ft_error("Error: duplicate light\n");
	if (count_tokens < 4)
		ft_error("Error: invalid light line\n");
